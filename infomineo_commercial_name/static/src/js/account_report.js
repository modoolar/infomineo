odoo.define("infomineo_commercial_name.account_report", function (require) {
    ...
    // Copied account_reports.account_report M2MFilters
    ...
    accountReportsWidget.include({
        custom_events: _.extend({}, accountReportsWidget.prototype.custom_events, {
            value_changed: function (ev) {
                ...
                self.report_options.commercial_names = ev.data.commercial_names;
        ...
        render_searchview_buttons: function () {
            ...
            if (this.report_options.partner) {
                if (!this.M2MFilters) {
                    ...
                    if ("commercial_names" in this.report_options) {
                        fields.commercial_names = {
                            label: _t("Commercial Name"),
                            modelName: "partner.commercial.name",
                            value: this.report_options.partner_categories.map(Number),
                        };
                    }
                    if (!_.isEmpty(fields)) {
